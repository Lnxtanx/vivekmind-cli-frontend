...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()(
  {
    head: () => ({
      meta: [
        ...
        {
          name: "description",
          content: "Open-source terminal AI coding assistant native to AWS Bedrock. Run Claude, Gemini, OpenAI, DeepSeek, and Grok in your terminal securely. BYOK — bring your own keys.",
        },
        { name: "robots", content: "index, follow" },
        { name: "keywords", content: "AI coding assistant, terminal AI, AWS Bedrock, Claude, GPT, Gemini, DeepSeek, open source CLI, coding agent, VivekMind" },
        { property: "og:title", content: "VivekMind CLI — AWS-Native Terminal AI Coding Agent" },
        {
          property: "og:description",
          content: "Open-source terminal AI coding assistant native to AWS Bedrock. Run Claude, Gemini, OpenAI, DeepSeek, and Grok in your terminal securely.",
        },
